...
(), function () {
	...
	e.$inject = ["$rootScope"],
	i.$inject = ["$stateProvider", "$urlRouterProvider"]
}
.call(this), function () {
	"use strict";
	function e() {
	...
	angular.module("core").controller("AppController", e),
...
.call(this), function () {
	...
	angular.module("core").service("$storage", t),
...
.call(this), function () {
	...
	angular.module("core").directive("mvVm", e),
	e.$inject = ["$animate", "TimelineLite", "TweenMax", "Cubic"]
}
.call(this), function () {
	"use strict";
	function e() {
	...
	function i(e) {
		function i(i, t, s, a) {
			i.isOpen = a.isOpen,
			i.toggleOpen = a.toggleOpen,
			i.$watch("isOpen", function (i) {
	...
	angular.module("core").directive("vmItem", i).directive("vmItemHeading", t).directive("vmItemLeft", s).directive("vmItemCenter", a).directive("vmItemTools", n).directive("vmItemContent", o).controller("vmItemController", e),
	e.$inject = ["$scope"],
	i.$inject = ["$animate"]
}
